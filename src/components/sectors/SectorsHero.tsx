    ...
    <section className="relative overflow-hidden bg-navy pt-16 pb-20 text-ivory md:pt-24 md:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="mt-6 max-w-4xl">
          ...
          <div className="my-6 h-0.5 w-20 bg-white/40" />
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            ...
            className="pill-btn inline-flex items-center gap-2 bg-white px-6 py-3 text-[14.5px] font-semibold text-navy hover:bg-white/90"
          >
            <span>Explore Sector Verticals</span>
            <span className="pill-btn-arrow">&rarr;</span>
          </a>
          <a
            href="#expert-bench"
            className="rounded-full border border-white/30 px-6 py-3 text-[14.5px] font-semibold text-white transition-colors hover:bg-white/10"
          >
