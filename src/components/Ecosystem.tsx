      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 divide-y divide-white/15 border-y border-white/15 md:grid-cols-4 md:divide-x md:divide-y-0">
          {layers.map((layer) => (
            ...
            >
              <div>
                <h3 className="mt-4 font-serif text-[20px] font-medium leading-snug text-white transition-colors duration-200 group-hover:text-gold-light">
                  {layer.title}
                </h3>
              ...
              <div className="mt-8 border-t border-white/10 pt-4">
                <p className="text-[11.5px] font-mono uppercase tracking-wider text-gray-400 transition-colors duration-200 group-hover:text-gold-light/70">{layer.metrics}</p>
                <a
                  href="#contact"
                  className="mt-3 inline-flex items-center gap-1 text-[12px] font-medium text-white/50 transition-all duration-200 hover:text-gold-light"
                >
                  <span>Enquire</span>
