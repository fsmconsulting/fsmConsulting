...
export default function Nav({ transparent = false }: { transparent?: boolean }) {
    ...
    const utilityCls = transparent
        ? "border-b border-white/15 bg-transparent text-[12px] text-white/70"
        : "border-b border-navy/10 bg-[#001326] text-[12px] text-gray-400";
    const brandCls = transparent ? "text-white" : "text-navy";
    const linkActiveCls = transparent
        ? "font-bold text-white after:absolute after:bottom-0 after:left-0 after:h-[2.5px] after:w-full after:bg-white"
    ...
    const linkIdleCls = transparent
        ? "font-medium text-white/85 hover:text-white after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-white/70 after:transition-all hover:after:w-full"
            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
                <div className="flex items-center gap-6">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 text-[14px] font-medium transition-colors lg:hidden ${transparent ? "text-white hover:text-white/70" : "text-navy hover:text-gold-light"}`}
                    ...
                    <Link href="/" className="group flex items-center gap-3">
                        ...
                        <div className="flex flex-col leading-none">
                            <span className={`font-serif text-[20px] font-semibold tracking-tight ${brandCls}`}>
                                FSM Consulting
                            </span>
                            <span className={`font-serif text-[20px] font-semibold tracking-tight pl-[7.5ch] ${brandCls}`}>
                                Limited
                            </span>
                        </div>
                    </Link>
                ...
                <nav className="hidden items-center gap-8 text-[14px] lg:flex">
                    ...
                    >
                        <button
                            ...
                            className={`flex items-center gap-1.5 cursor-pointer py-1.5 transition-colors focus:outline-none ${
                                isSectorsActive
                                    ? (transparent ? "font-bold text-white" : "font-bold text-navy")
                                    : (transparent ? "font-medium text-white/85 hover:text-white" : "font-medium text-navy/75 hover:text-navy")
                            }`}
                        ...
                        >
                            ...
                            <svg
                                className={`h-3.5 w-3.5 transition-transform duration-200 ${
                                    sectorsDropdownOpen ? (transparent ? "rotate-180 text-white" : "rotate-180 text-navy") : (transparent ? "text-white/70" : "text-navy/60")
                                }`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <Link
                        ...
                        className={`relative py-1.5 ${linkIdleCls}`}
                    >
                        Delivery Ecosystem
                    </Link>
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className={`hidden p-2 md:block ${transparent ? "text-white/70 hover:text-white" : "text-navy/60 hover:text-navy"}`}
                        aria-label="Search"
                        title="Search"
                    >
