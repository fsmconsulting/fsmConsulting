...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-[92vh] overflow-hidden bg-navy text-white flex flex-col justify-between">
    <section
      id="top"
    ...
    >
      ...
      {/* Main Hero Content Surface */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-32 pb-16 md:px-10 md:pt-40 md:pb-24 flex-1 flex flex-col justify-end">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-10 lg:px-12 pt-32 sm:pt-36 md:pt-44 pb-12 md:pb-16 flex-1 flex flex-col justify-between">
        <div className="max-w-[820px]">
          ...
          {/* Large Editorial Headline (56–88px Desktop / 42–56px Mobile per Design System §7.2) */}
          <h1 className="font-serif text-[42px] font-normal leading-[1.06] tracking-tight text-white sm:text-[56px] md:text-[68px] lg:text-[78px] xl:text-[84px]">
          ...
          {/* Supporting Copy Grounded in Corporate Profile */}
          <p className="mt-6 max-w-[56ch] text-[16px] leading-relaxed text-white/80 md:text-[18px]">
          ...
          <div className="mt-9 md:mt-11 flex flex-wrap items-center gap-5 sm:gap-6">
            ...
            <a
              href="#services"
              className="group inline-flex items-center gap-2 text-[14.5px] font-medium text-white/80 transition-colors hover:text-white"
        ...
        {/* Bottom Editorial Trust Markers */}
        <div className="mt-16 flex flex-wrap items-center justify-between gap-6 border-t border-white/15 pt-8 text-[12.5px] text-white/65">
          <div className="flex flex-wrap items-center gap-6 md:gap-8 font-mono text-[12px]">
        ...
        <div className="mt-16 md:mt-24 border-t border-white/15 pt-6 pb-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 font-mono text-[11.5px] md:text-[12px] text-white/60">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            ...
            <span>36 States + FCT Operational Coverage</span>
            <span>36 States + FCT Operational Reach</span>
            <span className="hidden sm:inline text-white/25">&bull;</span>
            <span>Pan-African Technical Bench</span>
            <span>Pan-African Delivery Bench</span>
          </div>

          <a
            href="#positioning"
            className="hidden items-center gap-1.5 text-white/60 hover:text-white transition-colors lg:inline-flex"
