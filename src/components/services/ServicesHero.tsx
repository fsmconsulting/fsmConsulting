      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <a
            ...
            className="group rounded-[var(--radius-card-sm)] border border-white/15 bg-white/5 p-5 transition-all duration-200 hover:border-white/40 hover:bg-white/10"
          >
            <span className="text-[11px] font-mono uppercase tracking-wider text-blue-bright">
              Cluster 01 &rarr;
            </span>
            <h3 className="mt-2 font-serif text-[18px] font-medium text-white group-hover:text-blue-bright">
